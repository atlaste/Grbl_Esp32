...
*/
#define MACHINE_NAME            "6 Pack Controller RS485 H2A XYYZ"
...
#define Z_LIMIT_PIN             GPIO_NUM_34 // second x limit switch

#define DEFAULT_INVERT_LIMIT_PINS       0  // Sets the default for N.O. switches

// 4x Input Module in Socket #2
// https://github.com/bdring/6-Pack_CNC_Controller/wiki/4x-Switch-Input-module
#define PROBE_PIN               GPIO_NUM_2   // labeled Probe -- probe
#define CONTROL_FEED_HOLD_PIN   GPIO_NUM_25  // labeled Reset -- oranje
#define PROBE_PIN2              GPIO_NUM_39  // labeled Probe #2
#define CONTROL_CYCLE_START_PIN GPIO_NUM_36  // labeled Start -- green
